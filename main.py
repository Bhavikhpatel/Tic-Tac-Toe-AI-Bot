...
def main():
    ...
    # Player selection before game starts
        ...
        for i in range(3):
            ...
            with col1:
                if st.button(st.session_state.board[i][0], key=f"00{i}"):
                    if st.session_state.board[i][0] == " " and \
                       st.session_state.current_turn == st.session_state.human_player:
